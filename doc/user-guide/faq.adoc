...
See the
http://www.onyxplatform.org/docs/user-guide/latest/scheduling.html[Scheduling
chapter] of the User Guide for a full explanation.
...
Message replay happens when a mesage enters Onyx from an input source,
...
specifics
http://www.onyxplatform.org/docs/cheat-sheet/latest/=catalog-entry/:onyx/pending-timeout[in
