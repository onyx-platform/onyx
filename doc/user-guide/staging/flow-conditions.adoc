...
TIP: Example project: https://github.com/onyx-platform/onyx-examples/tree/0.9.x/flow-combine[flow-combine]
...
TIP: Example project: https://github.com/onyx-platform/onyx-examples/tree/0.9.x/flow-exclude-keys[flow-exclude-keys]
...
TIP: Example project: https://github.com/onyx-platform/onyx-examples/tree/0.9.x/flow-predicate-composition[flow-predicate-composition]
...
TIP: Example project: https://github.com/onyx-platform/onyx-examples/tree/0.9.x/flow-short-circuit[flow-short-circuit]
