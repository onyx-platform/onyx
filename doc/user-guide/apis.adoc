...
The https://github.com/onyx-platform/onyx/blob/0.9.x/src/onyx/api.clj[Core API] is used to start/stop resources, jobs, and monitor job progress. It's accessible through the `onyx.api` namespace.
...
TIP: Example project: https://github.com/onyx-platform/onyx-examples/tree/0.9.x/block-on-job-completion[block-on-job-completion]
...
TIP: Example project: https://github.com/onyx-platform/onyx-examples/tree/0.9.x/kill-job[kill-job]
