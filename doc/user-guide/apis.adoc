...
The
https://github.com/onyx-platform/onyx/blob/0.9.x/src/onyx/api.cljlink:#core-api[Core
...
TIP: Example project:
https://github.com/onyx-platform/onyx-examples/tree/0.9.x/kill-joblink:#kill-job[kill-job]
...
The
https://github.com/onyx-platform/onyx/blob/0.6.x/src/onyx/peer/pipeline_extensions.clj[Peer
