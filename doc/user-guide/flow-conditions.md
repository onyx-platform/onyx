...
Example project: [flow-combine](https://github.com/onyx-platform/onyx-examples/tree/0.9.x/flow-combine)
...
Example project: [flow-exclude-keys](https://github.com/onyx-platform/onyx-examples/tree/0.9.x/flow-exclude-keys)
...
Example project: [flow-predicate-composition](https://github.com/onyx-platform/onyx-examples/tree/0.9.x/flow-predicate-composition)
...
Example project: [flow-short-circuit](https://github.com/onyx-platform/onyx-examples/tree/0.9.x/flow-short-circuit)
