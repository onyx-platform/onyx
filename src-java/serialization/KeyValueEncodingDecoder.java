...
@javax.annotation.Generated(value = {"onyx.serialization.KeyValueEncodingDecoder"})
@SuppressWarnings("all")
public class KeyValueEncodingDecoder
{
    public static final int ENCODED_LENGTH = -1;
    private int offset;
    private DirectBuffer buffer;

    public KeyValueEncodingDecoder wrap(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
