...
```
[org.onyxplatform/onyx "0.9.12-SNAPSHOT"]
```
...
### Developer's Guide 0.9.12-SNAPSHOT
...
### API Docs 0.9.12-SNAPSHOT

Code level API documentation [can be found here](http://www.onyxplatform.org/docs/api/0.9.12-SNAPSHOT).
