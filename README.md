...
```
[org.onyxplatform/onyx "0.8.9-SNAPSHOT"]
```

### Build Status

Component | `0.8.x`| `master` | `compatibility`
----------|--------|--------
...
learn-onyx| [![Circle CI](https://circleci.com/gh/onyx-platform/learn-onyx/tree/0.8.x.svg?style=svg)](https://circleci.com/gh/onyx-platform/learn-onyx/tree/0.8.x) | [![Circle CI](https://circleci.com/gh/onyx-platform/learn-onyx/tree/master.svg?style=svg)](https://circleci.com/gh/onyx-platform/learn-onyx/tree/master) | [![Circle CI](https://circleci.com/gh/onyx-platform/learn-onyx/tree/compatibility.svg?style=svg)](https://circleci.com/gh/onyx-platform/learn-onyx/tree/compatibility)

- `0.8.x`: stable, released content
- `master`: stable, unreleased content
...
Official plugins are vetted by Michael Drogalis. Ensure in your project that plugin versions directly correspond to the same Onyx version (e.g. `onyx-core-async` version `0.8.9-SNAPSHOT` goes with `onyx` version `0.8.9-SNAPSHOT`). Fixes to plugins can be applied using a 4th versioning identifier (e.g. `0.8.9-SNAPSHOT.1`).
