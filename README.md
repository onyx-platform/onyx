...
```
[org.onyxplatform/onyx "0.9.0-alpha7"]
```
...
----------|--------|----------|----------------
onyx core | [![Circle CI](https://circleci.com/gh/onyx-platform/onyx/tree/0.9.x.svg?style=svg)](https://circleci.com/gh/onyx-platform/onyx/tree/0.9.x) | [![Circle CI](https://circleci.com/gh/onyx-platform/onyx/tree/master.svg?style=svg)](https://circleci.com/gh/onyx-platform/onyx/tree/master) | `-`
...
### Developer's Guide 0.9.0-alpha7
...
### API Docs 0.9.0-alpha7

Code level API documentation [can be found here](http://www.onyxplatform.org/docs/api/0.9.0-alpha7).

### Official plugin listing

Official plugins are vetted by Michael Drogalis. Ensure in your project that plugin versions directly correspond to the same Onyx version (e.g. `onyx-core-async` version `0.9.0-alpha7` goes with `onyx` version `0.9.0-alpha7`). Fixes to plugins can be applied using a 4th versioning identifier (e.g. `0.9.0-alpha7.1`).
