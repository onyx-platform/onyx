...
`[org.onyxplatform/onyx-amazon-sqs "0.13.1-SNAPSHOT.0"]`, and read
...
### Developer's Guide 0.13.1-SNAPSHOT
...
### API Docs 0.13.1-SNAPSHOT

Code level API documentation [can be found here](http://www.onyxplatform.org/docs/api/0.13.1-SNAPSHOT).

### Official plugin listing

Official plugins are vetted by Michael Drogalis. Ensure in your project that plugin versions directly correspond to the same Onyx version (e.g. `onyx-kafka` version `0.13.1-SNAPSHOT.0-SNAPSHOT` goes with `onyx` version `0.13.1-SNAPSHOT`). Fixes to plugins can be applied using a 4th versioning identifier (e.g. `0.13.1-SNAPSHOT.1-SNAPSHOT`).
