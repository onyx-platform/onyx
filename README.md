...
`[org.onyxplatform/onyx-amazon-sqs "0.13.3.0"]`, and read
...
Code level API documentation [can be found here](http://www.onyxplatform.org/docs/api/0.13.3).

### Official plugin listing

Official plugins are vetted by Michael Drogalis. Ensure in your project that plugin versions directly correspond to the same Onyx version (e.g. `onyx-kafka` version `0.13.3.0-SNAPSHOT` goes with `onyx` version `0.13.3`). Fixes to plugins can be applied using a 4th versioning identifier (e.g. `0.13.3.1-SNAPSHOT`).
